...
function Gargoyle_m15_535100Battle_Activate(ai, goal)
    ...
    if not not ai:IsInsideTargetRegion(TARGET_ENE_0, 1512790) or not not ai:IsInsideTargetRegion(TARGET_ENE_0, 1512791) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1512792) then
        Act18Per = 100
...
function OnIf_535100(ai, goal, codeNo)
    ...
    local canStep702 = 0
    local canStep703 = 0
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 7, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 7, 1512703) then
        canStep711 = 1
    end
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 7, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 7, 1512703) then
        canStep713 = 1
    end
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_L, 7, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_L, 7, 1512703) then
        canStep712 = 1
    end
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 5, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 5, 1512703) then
        canStep701 = 1
    end
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 5, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 5, 1512703) then
        canStep703 = 1
    end
    if not not ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_L, 5, 1512702) or ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_L, 5, 1512703) then
        canStep702 = 1
    end
