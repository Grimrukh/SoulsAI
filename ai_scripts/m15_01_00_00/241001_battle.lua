...
function WhiteKnight_Lar_Sw241001Battle_Activate(ai, goal)
    ...
    local local0 = {Att3010_Dist_max, 75, 3010, DIST_Middle}
    defFuncParamTbl[1] = local0
    actFuncArr[2] = REGIST_FUNC(ai, goal, WhiteKnight_Lar_Sw241001_Act02)
    local0 = {Att3011_Dist_max, 75, 3011, DIST_Middle}
    defFuncParamTbl[3] = local0
    local0 = {Att3012_Dist_max, 75, 3012, DIST_Middle, 3007, DIST_Middle, nil}
