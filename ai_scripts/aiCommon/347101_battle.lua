...
function GoldenChimera347101Battle_Activate(ai, goal)
    ...
    elseif ai:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        ...
        elseif ai:GetNumber(3) == 1 then
            Act14Per = 100
        elseif not (not ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 9.5) or friendDist > 30) or not (not ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 11.4) or friendDist > 25) or not (not ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 14.3) or friendDist > 20) or not (not ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 18.9) or friendDist > 15) or ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 28.1) and friendDist <= 10 then
            Act18Per = 100
        elseif ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_R, 150) and targetDist <= 3 then
            Act02Per = 100
        elseif ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 150) and targetDist <= 3 then
...
Att3000_Dist_min = Att3021_Dist_max
function GoldenChimera347101_Act13(ai, goal, paramTbl)
    local approachDist = Att3021_Dist_max
...
function GoldenChimera347101Battle_Interupt(ai, goal)
    if ai:GetNumber(0) == 0 then
        ...
        elseif ai:HasSpecialEffectId(TARGET_SELF, 5522) then
            goal:ClearSubGoal()
