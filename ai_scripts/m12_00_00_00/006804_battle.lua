REGISTER_GOAL(GOAL_ForestHunterMage6804_Battle, "ForestHunterMage6804Battle")
local PushR_min = 0
local PushR_max = 1
...
local Magic2_min = 5
local Magic2_max = 15
REGISTER_GOAL_NO_UPDATE(GOAL_ForestHunterMage6804_Battle, 1)
function ForestHunterMage6804Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[3] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act03)
    actFuncArr[4] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act04)
    actFuncArr[6] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act06)
    actFuncArr[17] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act17)
    actFuncArr[18] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act18)
    actFuncArr[19] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act19)
    actFuncArr[20] = REGIST_FUNC(ai, goal, ForestHunterMage6804_Act20)
    local atkAfterFunc = REGIST_FUNC(ai, goal, ForestHunterMage6804_ActAfter_AdjustSpace, atkAfterOddsTbl)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    return 
end

PushR_min = NormalR2_max
function ForestHunterMage6804_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function ForestHunterMage6804_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    NPC_KATATE_Switch(ai, goal)
    CommonNPC_UseSecondaryRightHand(ai, goal)
...
function ForestHunterMage6804_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    NPC_KATATE_Switch(ai, goal)
    CommonNPC_UseSecondaryRightHand(ai, goal)
...
PushR_min = PushR_max
function ForestHunterMage6804_Act17(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
PushR_min = Magic_max
PushR_min = Magic_min
function ForestHunterMage6804_Act18(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function ForestHunterMage6804_Act19(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local R_Wep = ai:GetWepCateRight(TARGET_SELF)
    local Magic2Limit = ai:GetNumber(1)
...
function ForestHunterMage6804_Act20(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function ForestHunterMage6804_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local MoveDist = 3
    if fate <= 40 then
...
function ForestHunterMage6804Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
end

function ForestHunterMage6804Battle_Terminate(ai, goal)
    return 
end

function ForestHunterMage6804Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
