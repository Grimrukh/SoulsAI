...
function DragonZombi342000Battle_Activate(ai, goal)
    ...
    elseif ai:IsInsideTargetRegion(TARGET_ENE_0, 1102124) then
        ...
        Act06Per = 0
        Act07Per = 0
    elseif not not ai:IsInsideTargetRegion(TARGET_ENE_0, 1102125) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1102127) then
        Act01Per = 0
        Act02Per = 100
        Act03Per = 0
        Act04Per = 0
        ...
        Act06Per = 0
        Act07Per = 0
    elseif not not ai:IsInsideTargetRegion(TARGET_ENE_0, 1102126) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1102128) then
        Act01Per = 0
        Act02Per = 0
        Act03Per = 100
        Act04Per = 0
