...
function ArmoredTask_BackGuard346100Battle_Activate(ai, goal)
    ...
    if not not ai:IsInsideTargetRegion(TARGET_ENE_0, 1702750) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1702752) then
        Act09Per = 100
    elseif ai:IsFinishTimer(0) == true and 12 <= targetDist then
